...
<head>
    ...
    <style>
        *{
        ...
        .btn1
        {
            margin-left: 20px; /* Adjusted for smaller devices */
        }
        ...
        .dropdown-btn {
            ...
            outline: none;
            cursor: pointer;
            margin-right: 20px; /* Adjusted for smaller devices */
        }
        ...
        .bubbles 
        {
            ...
            position: absolute;
            bottom: -5vh; /* Adjusted for smaller devices */
            opacity: 30%;
        }
        ...
        {
            animation-delay: 2s;
            width: 2.5vw; /* Adjusted for responsiveness */
        }
        ...
        {
            animation-delay: 6s;
            width: 2vw; /* Adjusted for responsiveness */
        }
        .bubbles img:nth-child(7)
        {
            animation-delay: 7s;
            width: 3.5vw; /* Adjusted for responsiveness */
        }
